...
const TESTIMONIALS = [
  {
    name: "Priya M.",
    city: "Mumbai",
    text: "The muslin swaddles are SO soft! My newborn sleeps so much better wrapped in them. Will order again!",
    stars: 5,
    emoji: "🌸",
  },
  {
    name: "Rohan & Deepa",
    city: "Bangalore",
    text: "The dry sheets are a lifesaver — totally waterproof and the prints are adorable. Best baby buy!",
    stars: 5,
    emoji: "⭐",
  },
  {
    name: "Anita K.",
    city: "Delhi",
    text: "Ordered the romper set and the baby nest. Quality is amazing for the price. Highly recommend!",
    stars: 5,
    emoji: "💛",
  },
];
        ...
        <div className="container hero__inner">
          <div className="hero__content">
            ...
            <p className="hero__subtitle hero-animate">
              Premium baby essentials — soft, safe, and full of joy. From
              snuggly swaddles to waterproof dry sheets, crafted with love for
              your little one.
            </p>
        ...
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-sub">
               {categories.length} thoughtfully curated categories of premium baby essentials
            </p>
          </div>
              ...
              {categories.map((category, i) => (
                ...
                >
                  <div className="category-card__body">
                    ...
                    <p className="category-card__tagline">
      ...
      <section className="home-section">
        <div className="container">
          <div className="section-header">
            ...
            <p className="section-sub">
              Because your baby deserves only the best
            </p>
          </div>
          ...
          <div className="cta-banner">
            <div className="cta-banner__content">
              ...
              <p className="cta-banner__desc">
                Custom prints, bulk orders, or personalized designs — we're here
                to create the perfect baby essentials just for you.
              </p>
              <button
                className="btn-primary"
